---
title: "Atajos de teclado en Windows 11 para ser productivos"
date: 2022-03-20
categories: 
  - "windows"
tags: 
...
Aparte de todo lo citado en este apartado pueden seguir las siguientes instrucciones para crear [atajos de teclado personalizados para abrir aplicaciones]({{< relref "/posts/crear-atajos-de-teclado-para-abrir-programas-en-windows" >}}). Si lo creen oportuno pueden instalar launchers de aplicaciones. En su día use y me gusto el lanzador [Launchy](https://www.launchy.net/download.php). En estos momentos no uso Launchy porque el menú de inicio de Windows me permite realizar exactamente lo mismo.
...
[![Gestión del portapapeles de Windows](images/portapeles-de-windows-271x300.png "Gestión del portapapeles de Windows")](images/portapeles-de-windows.png)
...
| Atajo de teclado | Función |
| --- | --- |
| `Ctrl + número_pestaña (1-8)` | Para dirigirnos a la pestaña que queramos. Podemos elegir cualquier pestaña de la 1 a la 8. Para ello es interesante usar alguna [extensión que te numere las pestañas]({{< relref "/posts/numerar-las-pestanas-del-navegador-en-firefox-y-chrome" >}}). |
