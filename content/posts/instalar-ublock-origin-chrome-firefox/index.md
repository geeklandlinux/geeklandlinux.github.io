---
title: "Instalar uBlock origin en Chrome y en Firefox"
date: 2016-07-16
categories: 
  - "varios"
tags: 
...
[![Muestra de una página web con publicidad](images/Página-web-con-publicidad-300x205.png)](images/Página-web-con-publicidad.png)
...
[![Muestra de una página web sin publicidad](images/Página-web-sin-publicidad-300x205.png)](images/Página-web-sin-publicidad.png)
...
[![Añadir ublock origin en Chrome](images/Añadir-ublock-origin-en-Chrome.png)](images/Añadir-ublock-origin-en-Chrome.png)

Seguidamente aparecerá la siguiente ventana en la que deberemos clicar encima del botón **Añadir extensión**.

[![Instalar ublock origin en Chrome](images/Instalar-ublock-origin-en-Chrome-300x180.png)](images/Instalar-ublock-origin-en-Chrome.png)
...
[![Agregar ublock origin en Firefox](images/Agregar-ublock-origin-en-Firefox-300x187.png)](images/Agregar-ublock-origin-en-Firefox.png)

Seguidamente aparecerá la siguiente ventana en la que deberemos clicar encima del botón del botón **Instalar**.

[![Instalar ublock origin en Firefox](images/Instalar-ublock-origin-en-Firefox-300x187.png)](images/Instalar-ublock-origin-en-Firefox.png)
...
4. uBlock Origin se distribuye bajo la licencia GPLv3 y es software libre. Si alguien quiere conocer más acerca de las ventajas que proporciona el software libre puede leer el siguiente [artículo]({{< relref "/posts/ventajas-software-libre-sobre-privativo" >}}).
...
###### Nota: Si quieren usar un bloqueador de publicidad para su teléfono móvil Android pueden seguir las instrucciones del siguiente [link]({{< relref "/posts/navegar-sin-anuncios-en-android" >}})
