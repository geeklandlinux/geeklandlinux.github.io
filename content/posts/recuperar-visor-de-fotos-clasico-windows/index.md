---
title: "Como recuperar el visor de fotos clásico en Windows 10"
date: 2017-05-04
categories: 
  - "windows"
tags: 
...
[![Ejecutar el fichero para recuperar el visor de fotos clásico](images/ejecutar-fichero-para-modificar-registro.png "Ejecutar el fichero para recuperar el visor de fotos clásico")](images/ejecutar-fichero-para-modificar-registro.png)

A continuación, aparecerá la siguiente advertencia de seguridad en la que deberemos clicar Ejecutar.

[![Ejecutar el fichero .reg](images/ejecutar-fichero-reg-300x207.png "Ejecutar el fichero .reg")](images/ejecutar-fichero-reg.png)
...
[![Confirmar la modificación del registro](images/confirmar-modificacion-del-registro.png "Confirmar la modificación del registro")](images/confirmar-modificacion-del-registro.png)
...
[![Claves del registro modificadas](images/claves-de-registro-modificadas.png "Claves del registro modificadas")](images/claves-de-registro-modificadas.png)
...
[![Entrar al panel de configuración de Windows 10](images/panel-configuracion-windows-10-300x238.png "Acceder a la configuración del sistema de Windows")](images/panel-configuracion-windows-10.png)
...
[![Seleccionar el visor de fotos clásico como programa predeterminado](images/programa-predeterminado-para-imaganes.png "Seleccionar el visor de fotos clásico como programa predeterminado")](images/programa-predeterminado-para-imaganes.png)
...
[![Abrir una imagen con el visor de fotos clásico](images/abrir-imagen-con-el-visor-de-fotos-clasico.png "Abrir una imagen con el visor de fotos clásico")](images/abrir-imagen-con-el-visor-de-fotos-clasico.png)

Si lo prefieren también pueden [usar un programa predeterminado en función de la extensión]({{< relref "/posts/programa-predeterminado-para-abrir-archivo" >}}) de la imagen a visualizar.
