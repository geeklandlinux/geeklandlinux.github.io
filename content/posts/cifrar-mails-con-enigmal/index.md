...
[https://geeklandlinux.github.io/posts/razones-para-cifrar-y-firmar-mail/]({{< relref "/posts/razones-para-cifrar-y-firmar-mail" >}})
...
###### Nota: Si quisiéramos hacer el proceso de forma manual vía terminal únicamente necesitaríamos instalar el paquete GnuPG. Existen otras alternativas de cifrado que se pueden consultar al siguiente post: [https://geeklandlinux.github.io/posts/razones-para-cifrar-y-firmar-mail/]({{< relref "/posts/razones-para-cifrar-y-firmar-mail" >}})
...
[https://geeklandlinux.github.io/posts/instalar-firefox-y-thunderbird-en-debian-facilmente/]({{< relref "/posts/instalar-firefox-y-thunderbird-en-debian-facilmente" >}})
...
[![Acceso a la configuración de Gmail](images/2-Acceso-a-la-configuración-de-cuenta.png "2- Acceso a la configuración de cuenta")](images/2-Acceso-a-la-configuración-de-cuenta.png)
...
[![Accediendo a Imap](images/3-Acceso-a-configuracion-IMAP.png "3- Acceso a configuracion IMAP")](images/3-Acceso-a-configuracion-IMAP.png)
...
[![Activación de IMAP](images/4-Habilitar-IMAP.png "4- Habilitar IMAP")](images/4-Habilitar-IMAP.png)
...
[![Añadir cuenta en Thunderbird para cifrar mails](images/5-Añadir-cuenta-de-correo-a-Thunderbird.png "5- Añadir cuenta de correo a Thunderbird")](images/5-Añadir-cuenta-de-correo-a-Thunderbird.png)
...
[![Descartar servicios de correo electrónico](images/6-Saltarse-esto.png "6- Saltarse esto")](images/6-Saltarse-esto.png)
...
[![Introducción de los datos de nuestra cuenta de correo](images/7-Configuración-de-la-cuenta-de-correo.png "7- Configuración de la cuenta de correo")](images/7-Configuración-de-la-cuenta-de-correo.png)

Entonces aparecerá la siguiente pantalla:

[![Introducción de la configuración de nuestra cuenta de correo](images/8-Cuenta-configurada-automaticamente.png "8- Cuenta configurada automaticamente")](images/8-Cuenta-configurada-automaticamente.png)
...
[![Cuenta de correo funcionando y debidamente configurada](images/9-Cuenta-configurada.png "9- Cuenta configurada")](images/9-Cuenta-configurada.png)
...
[![gnupg para cifrar mails](images/10-Instalación-de-gnupg.png "10- Instalación de gnupg")](images/10-Instalación-de-gnupg.png)
...
[![Instalar enigmail para cifrar mails](images/11-Instalación-de-enigmail.png "11- Instalación de enigmail")](images/11-Instalación-de-enigmail.png)
...
[![Buscar extensión enigmail para cifrar mails](images/12-Buscar-Enigmail.png "12- Buscar Enigmail")](images/12-Buscar-Enigmail.png)

Una vez a encontrada la extensión Enigmail tal y como se puede ver en la captura **presionamos el botón de instalar**:

[![Instalar Enigmail para cifrar mails](images/13-Instalar-Enigmail.png "13- Instalar Enigmail")](images/13-Instalar-Enigmail.png)

Una vez se haya instalada la extensión, tendremos que **reiniciar Thunderbird presionado el link Reiniciar ahora**.

[![Reiniciar Enigmail](images/14-Reiniciar-Enigmail.png "14- Reiniciar Enigmail")](images/14-Reiniciar-Enigmail.png)

## GENERAR UN PAR DE CLAVES

Una vez reiniciado Thunberbird observareis que aparece un menú que se llama llama OpenPGP:

[![Administración de claves para cifrar mails](images/15-Administración-de-claves.png "15- Administración de claves")](images/15-Administración-de-claves.png)
...
[![Generar claves para cifrar mails](images/16-Generar-nuevo-par-de-llaves.png "16- Generar nuevo par de claves")](images/16-Generar-nuevo-par-de-llaves.png)
...
[![Opciones de configuración para crear las claves para cifrar mails](images/17-Opciones-de-configuración-para-crear-la-clave.png "17- Opciones de configuración para crear la clave")](images/17-Opciones-de-configuración-para-crear-la-clave.png)
...
[![Selección del tipo de cifrado para cifrar mails](images/18-Opciones-de-configuración-avanzadas-para-crear-la-clave.png "18- Opciones de configuración avanzadas para crear la clave")](images/18-Opciones-de-configuración-avanzadas-para-crear-la-clave.png)
...
[![Generar el certificado de revocación](images/19-Generar-certificado-de-revocación.png "19- Generar certificado de revocación")](images/19-Generar-certificado-de-revocación.png)
...
[![Exportar claves secretas para cifrar mails](images/20-Exportar-Claves-Secretas.png "20- Exportar Claves Secretas")](images/20-Exportar-Claves-Secretas.png)
...
[![Selección si se exportan la totalidad de claves o solo las públicas](images/21-Exportar-Claves-Secretas.png "21- Exportar Claves Secretas")](images/21-Exportar-Claves-Secretas.png)
...
[![Opciones de configuración para cifrar mails](images/22-Configuración-Opciones-OpenPGP.png "22- Configuración Opciones OpenPGP")](images/22-Configuración-Opciones-OpenPGP.png)
...
[![Opciones disponibles para cifrar mails](images/23-Configuración-Opciones-OpenPGP.png "23- Configuración Opciones OpenPGP")](images/23-Configuración-Opciones-OpenPGP.png)
...
[![Modificación de las opciones estandard para cifrar mails](images/24-que-pasa-si-queremos-modificar-las-opciones-estandard.png "24- que pasa si queremos modificar las opciones estandard")](images/24-que-pasa-si-queremos-modificar-las-opciones-estandard.png)
...
[![cifrar mails en función del usuario](images/25-Introducción-de-reglas-por-usuario.png "25- Introducción de reglas por usuario")](images/25-Introducción-de-reglas-por-usuario.png)
...
[![Introducción de reglas para enviar mails cifrados en función del usuario](images/26-Introducir-Reglas-en-función-del-usuario.png "26- Introducir Reglas en función del usuario")](images/26-Introducir-Reglas-en-función-del-usuario.png)

En esta pantalla tan solo tenemos que **apretar el botón Añadir**. Una vez apretado el botón aparecerá el siguiente menú:

[![Introducción de las reglas para cifrar mails](images/27-Introducción-de-reglas-por-usuario.png "27- Introducción de reglas por usuario")](images/27-Introducción-de-reglas-por-usuario.png)
...
[![Instrucciones para cifrar mails](images/28-Prueba-envío-mail.png "28- Prueba envío mail")](images/28-Prueba-envío-mail.png)
...
[![Llaves no disponibles para cifrar mails](images/29-llaves-no-disponibles.png "29- llaves no disponibles")](images/29-llaves-no-disponibles.png)
...
[![Selección del servidor de claves públicas para cifrar mails](images/30-Seleccionar-el-servidor-de-claves-para-descargar.png "30- Seleccionar el servidor de claves para descargar")](images/30-Seleccionar-el-servidor-de-claves-para-descargar.png)
...
[![Selección de la clave pública para cifrar mails](images/31-Seleccion-de-la-clave-pública.png "31- Seleccion de la clave pública")](images/31-Seleccion-de-la-clave-pública.png)
...
[![Instrucciones para descifrar un mail](images/Descifrado-automático-de-correos.png "Descifrado automático de correos")](images/Descifrado-automático-de-correos.png)
...
[![Distribución de la clave pública para cifrar mails](images/32-Enviar-claves-públicas.png "32- Enviar claves públicas")](images/32-Enviar-claves-públicas.png)
...
[![Contenido almacenado en los servidores de google](images/33-Lo-que-google-verá.png "33- Lo que google verá")](images/33-Lo-que-google-verá.png)
