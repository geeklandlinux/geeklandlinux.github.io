...
[![1- Copia de los archivos para la conexión](images/1-Copia-de-los-archivos-para-la-conexión.png "Copia los archivos para conectarse al servidor OpenVPN en iOS")](images/1-Copia-de-los-archivos-para-la-conexión.png)
...
[![2- Instalar cliente OpenVPN en iOS](images/2-Instalar-cliente-OpenVPN.png "Instalación del cliente OpenVPN en iOS")](images/2-Instalar-cliente-OpenVPN.png)
...
[![3- Renombar archivo configuración cliente](images/3-Renombar-archivo-configuración-cliente.png "Cambiar la extensión de .conf a .ovpn")](images/3-Renombar-archivo-configuración-cliente.png)
...
[![4- Pasos a realizar en iTunes](images/4-Pasos-a-realizar-en-iTunes.png "Localización de la aplicación OpenVPN en iTunes")](images/4-Pasos-a-realizar-en-iTunes.png)
...
[<img src="images/5-Copiar-claves-al-iPad-o-iPhone.png" alt="5- Copiar claves al iPad o iPhone" title="Copiar las claves y configuración del cliente en el iPad" style="zoom:80%;" />](images/5-Copiar-claves-al-iPad-o-iPhone.png)
...
[![6- Importar Perfil](images/6-Importar-Perfil.png "Importar el perfil del cliente al Ipad o iPhone")](images/6-Importar-Perfil.png)
...
[<img src="images/7-Introducir-usuario-y-contraseña.png" alt="7- Introducir usuario y contraseña para conectarse al servidor OpenVPN en iOS" title="Introducción del usuario y contraseña" style="zoom:80%;" />](images/7-Introducir-usuario-y-contraseña.png)
...
[<img src="images/8-Conectado-al-servidor-OpenVPN.png" alt="8- Conectado al servidor OpenVPN en iOS" title="Conexión del cliente al servidor OpenVPN en iOS" style="zoom:80%;" />](images/8-Conectado-al-servidor-OpenVPN.png)
