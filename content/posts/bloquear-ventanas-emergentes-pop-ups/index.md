---
title: "Bloquear todas las ventanas emergentes o pop-ups en Chrome y Firefox"
date: 2017-11-26
categories: 
  - "tips"
tags: 
...
[![Permitir ventanas emergentes en una web determinada](images/anadir-excepcion-chrome.png "Permitir ventanas emergentes en una web determinada")](images/anadir-excepcion-chrome.png)
...
[![Permitir ventanas emergentes en un dominio](images/permitir-ciertos-pop-ups.png "Permitir ventanas emergentes en un dominio")](images/permitir-ciertos-pop-ups.png)
...
[![Bloquear ventanas pop-up en Firefox](images/bloquear-popups-firefox.png "Bloquear ventanas pop-up en Firefox")](images/bloquear-popups-firefox.png)
...
[![Añadir excepciones en el bloqueo de ventanas emergentes](images/anadir-excepciones-ventanas-emergentes-firefox.png "Añadir excepciones en el bloqueo de ventanas emergentes")](images/anadir-excepciones-ventanas-emergentes-firefox.png)
...
[![Permitir los pop-up en un dominio determinado](images/permitit-popups-dominio-firefox.png "Permitir los pop-up en un dominio determinado")](images/permitit-popups-dominio-firefox.png)
...
[![Bloquear ventanas emergentes con uBlock Origin](images/bloquear-pop-up-ublock-origin.png "Bloquear ventanas emergentes con uBlock Origin")](images/bloquear-pop-up-ublock-origin.png)
...
[![Bloquear elementos de una web con ublock origin](images/bloquear-elementos-ublock-origin.png "Bloquear elementos de una web con ublock origin")](images/bloquear-elementos-ublock-origin.png)

A continuación seleccionamos el elemento que queremos bloquear clicando encima.

[![Seleccionar el elemento a bloquear](images/seleccionar-elemento-bloquear.png "Seleccionar el elemento a bloquear")](images/seleccionar-elemento-bloquear.png)
...
[![Crear una regla para eliminar una ventana emergente](images/crear-regla-eliminar-pop-up.png "Crear una regla para eliminar una ventana emergente")](images/crear-regla-eliminar-pop-up.png)
...
2. La mayoría de pop-up se muestran mediante la ejecución de código javascript. Por lo tanto para que no aparezcan podemos [bloquear la ejecución de código javascript]({{< relref "/posts/evitar-deteccion-adblock-con-anti-adblock-killer" >}}) en nuestro navegador. Si aplicamos este tipo de procedimiento es posible que hayan partes de ciertas páginas web que dejen de funcionar.
