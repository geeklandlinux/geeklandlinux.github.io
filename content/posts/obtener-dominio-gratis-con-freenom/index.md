---
title: "Obtener un dominio gratis y precauciones a tomar con los dominio gratis"
date: 2019-12-08
categories: 
  - "varios"
tags: 
...
[![Acceder a registrar el dominio](images/acceder-a-regisrar-dominio-gratis.png "Acceder a registrar un dominio gratis")](images/acceder-a-regisrar-dominio-gratis.png)

Acto seguido tecleamos el nombre del dominio que queremos registrar y presionamos el botón de Comprobar disponibilidad.

[![Comprobando la disponibilidad](images/comprobar-la-disponibilidad-del-dominio.png "Comprobando la disponibilidad de un dominio")](images/comprobar-la-disponibilidad-del-dominio.png)
...
[![Seleccionar el dominio que queremos](images/seleccionar-el-dominio-que-queremos.png "Seleccionar el dominio que queremos")](images/seleccionar-el-dominio-que-queremos.png)

A continuación clicaremos en el botón de Finalizar compra.

[![finalizar la compra del dominio gratis](images/finalizar-la-compra-del-dominio-gratis.png "finalizar la compra del dominio gratis")](images/finalizar-la-compra-del-dominio-gratis.png)
...
[![Seleccionar el tiempo que queremos usar el dominio](images/tiempo-uso-dominio.png "Seleccionar el tiempo que queremos usar el dominio")](images/tiempo-uso-dominio.png)
...
[![Aceptar las condiciones de servicio y aceptar el pedido](images/aceptar-condiciones-servicio.png "Aceptar las condiciones de servicio y aceptar el pedido")](images/aceptar-condiciones-servicio.png)
...
[![Gestionando el dominio mediante la interfaz web](images/gestionar-nuestro-dominio.png "Gestionando el dominio mediante la interfaz web")](images/gestionar-nuestro-dominio.png)
