---
title: "Instalar extensiones y gestionarlas en el navegador Microsoft Edge"
date: 2016-08-18
categories: 
  - "windows"
tags: 
...
[![Acceder al menú extensiones de Edge](images/Acceder-a-las-extensiones-de-Microsoft-Edge-300x261.png)](images/Acceder-a-las-extensiones-de-Microsoft-Edge.png)

A continuación tenemos que clicar encima de la opción **Obtener extensiones de la Tienda**.

[![Ver las extensiones disponibles en la tienda](images/Ver-las-extensiones-disponibles-en-Microsoft-Edge-300x261.png)](images/Ver-las-extensiones-disponibles-en-Microsoft-Edge.png)
...
[![Clicar encima de la extensión a Instalar](images/Clicar-encima-de-la-extensión-que-queremos-instalar-300x222.png)](images/Clicar-encima-de-la-extensión-que-queremos-instalar.png)

Finalmente presionamos encima del botón **Gratis** y la extensión se descargará e instalará.

[![Instalar una extensión en Edge](images/Instalar-la-extensión-seleccioanda-300x266.png)](images/Instalar-la-extensión-seleccioanda.png)
...
[![Iniciar la extensión instalada](images/Iniciar-la-extensión-instalada-300x266.png)](images/Iniciar-la-extensión-instalada.png)
...
[![Activar extensión en Microsoft Edge](images/Activar-la-extensión-instalada-300x261.png)](images/Activar-la-extensión-instalada.png)
...
[![Acceder a la configuración de las extensiones](images/Acceder-a-la-confitguración-de-la-extensión-300x296.png)](images/Acceder-a-la-confitguración-de-la-extensión.png)

Finalmente aparecerá un menú en el que podremos configurar y gestionar la extensión en cuestión.

[![Opciones de configuración de las extensiones](images/Opciones-de-configuración-disponibles-en-la-extensión-293x300.png)](images/Opciones-de-configuración-disponibles-en-la-extensión.png)
...
[![Acceder a Agregar o Quitar programas](images/Acceder-a-Agregar-o-Quitar-programas-194x300.png)](images/Acceder-a-Agregar-o-Quitar-programas.png)
...
[![Desinstalar extensiones en microsoft Edge](images/Desinstalar-una-extensión-en-Microsoft-Edge-226x300.png)](images/Desinstalar-una-extensión-en-Microsoft-Edge.png) Con estos simples pasos podremos instalar, configurar y desinstalar extensiones en Microsoft Edge de forma rápida y sencilla.
